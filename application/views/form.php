		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php echo base_url("formapp/insert")?>">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="text" name="email" placeholder="Email adresnizi giriniz.">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Maaşlar</span>
					<div>
						<select class="selection-2" name="badget">
							<option>6000 $</option>
							<option>1500 $</option>
							<option>2000 $</option>
							<option>2500 $</option>
